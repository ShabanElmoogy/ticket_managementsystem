...
ALTER TABLE "epic_watchers" ADD CONSTRAINT "epic_watchers_epic_id_epics_id_fk" FOREIGN KEY ("epic_id") REFERENCES "public"."epics"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
