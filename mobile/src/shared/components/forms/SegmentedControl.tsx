...
const styles = StyleSheet.create({
  track:  { flexDirection: 'row', borderRadius: Radius.md, padding: 2, gap: 2, alignSelf: 'flex-start' },
  option: { paddingHorizontal: 16, paddingVertical: 6, borderRadius: Radius.sm, minWidth: 50, alignItems: 'center', justifyContent: 'center', minHeight: 32 },
