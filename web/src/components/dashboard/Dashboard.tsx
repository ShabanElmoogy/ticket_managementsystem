...
const Dashboard: React.FC = () => {
  ...
  return (
    <Box>
      ...
      <DashboardContent {...dashboardProps} onAddComment={dashboardProps.handleAddComment} onCreateTicket={dashboardProps.handleCreateTicket} onRefresh={dashboardProps.fetchData} onTicketClick={dashboardProps.handleTicketClick} onTakeTicket={dashboardProps.handleTakeTicket} onUpdateStatus={dashboardProps.handleUpdateTicketStatus} onDeleteTicket={dashboardProps.handleDeleteTicket} onBulkUpdateStatus={dashboardProps.handleBulkUpdateStatus} />
      <TicketDetailsDialog
